...
public class BasePage extends BaseTest {
	    ...
	    static com.numadic.pom.util.Log Log = new Log();
	    ...
	    public void navigateBack() throws Exception {
	        ...
	        try {
	            ...
	            com.numadic.pom.util.Log.error(" Navigating back to the previous screen is not successful");
	        }
	    ...
	    public void switchWindow() throws Exception {
	        ...
	        try {
	            ...
	            com.numadic.pom.util.Log.info("Switching window is successful");
	        } catch (Exception e) {
